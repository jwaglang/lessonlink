...
| `livePerformanceNotes` | string | no | Optional. T's write-up of live mechanics (magic wand, ManyCam, props, voice work, theatrical reveals) that the deck doesn't capture. Authored by T after import; not generated by KUPT/Claude. |
