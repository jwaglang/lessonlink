...
import { ShoppingBag, Loader2, ChevronDown, ChevronRight, Edit2, Plus, Wand2, Rocket, Star, Flame, Wind, Droplet, Zap, Package, Sparkles, Heart, Leaf, Trees, Bug, Bird } from 'lucide-react';
          ...
          <div className="space-y-4 py-4">
            ...
            <div>
              ...
              <Select value={newCollectionIconType} onValueChange={setNewCollectionIconType}>
                ...
                <SelectContent>
                  <SelectItem value="sparkles">✨ Sparkles - Stars, magic, shine</SelectItem>
                  <SelectItem value="wind">🌬️ Wind - Air, steam, movement</SelectItem>
                  <SelectItem value="wand">✨ Wand - Magic, spells, wizard</SelectItem>
                  <SelectItem value="rocket">🚀 Rocket - Space, speed, adventure</SelectItem>
                  <SelectItem value="flame">🔥 Flame - Fire, heat, energy</SelectItem>
                  <SelectItem value="droplet">💧 Droplet - Water, liquid, cool</SelectItem>
                  <SelectItem value="zap">⚡ Zap - Electric, energy, power</SelectItem>
                  <SelectItem value="star">⭐ Star - Excellence, merit</SelectItem>
                  <SelectItem value="heart">❤️ Heart - Love, care, emotion</SelectItem>
                  <SelectItem value="leaf">🍃 Leaf - Nature, jungle, plants</SelectItem>
                  <SelectItem value="tree">🌲 Tree - Forest, nature, wildlife</SelectItem>
                  <SelectItem value="bug">🐛 Bug - Insects, jungle creatures</SelectItem>
                  <SelectItem value="bird">🐦 Bird - Flying, sky, freedom</SelectItem>
                  <SelectItem value="default">📦 Default - Generic, placeholder</SelectItem>
                </SelectContent>
              </Select>
            </div>
          </div>
