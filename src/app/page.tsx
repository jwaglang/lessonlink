...
export default function LandingPage() {
  ...
  // ── Render parent form fields inline ──
              ...
              <div className="mt-4">
                ...
                {signupStep === 4 && (
                  <div className="space-y-6">
                    ...
                    <ParentFields label="Primary Contact" parent={signupPrimary} setter={setSignupPrimary} />
                    <div className="border-t pt-4">
                      <ParentFields label="Secondary Contact (optional)" parent={signupSecondary} setter={setSignupSecondary} />
                    </div>
                  </div>
                )}
